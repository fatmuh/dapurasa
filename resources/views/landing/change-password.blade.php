...
@section('title')
<title>Dapurasa - Ganti Password</title>
@endsection
    ...
    <div class="container">
        <div class="row h-100">
            <div class="col-lg-7 mx-auto text-center mb-6">
                <h5 class="fw-bold fs-3 fs-lg-5 lh-sm mb-3">Ganti Password</h5>
            </div>
        </div>
        <div>
            <form class="row g-3" action="{{ route('landing.changePassword.post') }}" method="POST">
                @csrf
                <div class="col-md-12">
